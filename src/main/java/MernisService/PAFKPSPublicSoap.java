...
public class PAFKPSPublicSoap
{
    ...
    public PAFKPSPublicSoap(){}

    public PAFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PAFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PAFExtendedSoapSerializationEnvelope envelope= new PAFExtendedSoapSerializationEnvelope(PAFExtendedSoapSerializationEnvelope.VER11);
