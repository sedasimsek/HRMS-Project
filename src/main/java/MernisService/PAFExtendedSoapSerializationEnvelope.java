...
public class PAFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PAFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PAFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PAFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PAFDateTimeConverter dateTimeConverter = new PAFStandardDateTimeConverter();

    public PAFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PAFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PAFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PAFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PAFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PAFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
